/* Tauri NSIS custom messages - Simplified Chinese
   Keys must match English.nsh from tauri-bundler.
*/
LangString addOrReinstall ${LANG_SIMPCHINESE} "添加/重新安装组件"
LangString alreadyInstalled ${LANG_SIMPCHINESE} "已安装"
LangString alreadyInstalledLong ${LANG_SIMPCHINESE} "${PRODUCTNAME} ${VERSION} 已安装。请选择要执行的操作，然后单击“下一步”继续。"
LangString appRunning ${LANG_SIMPCHINESE} "{{product_name}} 正在运行！请先关闭后再重试。"
...
LangString dontUninstallDowngrade ${LANG_SIMPCHINESE} "不卸载（此安装程序不允许在不卸载的情况下降级）"
LangString failedToKillApp ${LANG_SIMPCHINESE} "无法结束 {{product_name}}。请先关闭后再重试。"
LangString installingWebview2 ${LANG_SIMPCHINESE} "正在安装 WebView2…"
LangString newerVersionInstalled ${LANG_SIMPCHINESE} "系统中已安装更新版本的 ${PRODUCTNAME}！不建议安装旧版本。若仍要安装此旧版本，建议先卸载当前版本。请选择要执行的操作，然后单击“下一步”继续。"
LangString older ${LANG_SIMPCHINESE} "较旧"
LangString olderOrUnknownVersionInstalled ${LANG_SIMPCHINESE} "系统中已安装 $R4 版本的 ${PRODUCTNAME}。建议先卸载当前版本再安装。请选择要执行的操作，然后单击“下一步”继续。"
LangString silentDowngrades ${LANG_SIMPCHINESE} "此安装程序已禁用降级，无法以静默方式继续，请改用图形界面安装程序。$\n"
...
LangString webview2AbortError ${LANG_SIMPCHINESE} "WebView2 安装失败！应用无法在没有它的情况下运行。请尝试重新运行安装程序。"
